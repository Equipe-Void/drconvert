	...
	return (
		<div className="bg-black1 rounded-md min-w-[30.938rem] px-6 py-6 hover:bg-black1/85 duration-200">
			...
			<div className="flex justify-end">
				<div onClick={() => router.push("/project")} className="cursor-pointer w-max font-bold text-white/75 text-xs bg-gray2/35 rounded-md px-4 py-3 hover:text-white duration-200">
					IR PARA O PROJETO
				</div>
			</div>
		</div>
