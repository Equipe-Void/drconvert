        ...
        <div className="flex-1 translate-y-[15%]">
          <div className="flex flex-col gap-10 max-w-[25rem]">
            <h1 className="font-bold text-white text-[2.5rem] leading-[52px]">
              Converta
              <br />
              seus dados. <span className="text-pink text-[2rem]">DrConvert</span>
            </h1>
            <p className="font-light text-white/75">
              Oferecemos uma <span className="font-bold text-white">solução simples</span> para
              converter e mapear seus arquivos <span className="font-bold text-white">CSV</span>,
              permitindo o gerenciamento e <span className="font-bold text-white">análise</span> dos
          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="w-full flex flex-col gap-8">
              ...
              <div className="w-full flex items-center gap-4">
                ...
                <p className="text-xs lg:text-sm text-gray1 font-regular">Lembrar de mim?</p>
              </div>
            </div>
